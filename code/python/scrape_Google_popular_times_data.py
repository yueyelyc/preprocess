...
with open('../../data/bell_labs_4sq_poi2.csv') as csvfile:
...
counter = 0
for poi in POIs[:100]:
    keyword = "{}, {}, {}, NJ".format(poi['name'], poi['address'], poi['town'])
    counter += 1
    ##Open a web page. 
    ...
    if counter % 10 == 0:
        with open("../../output/popular_times_full.json", 'w') as outfile:
            json.dump(popular_times, outfile)
        with open("../../output/popular_times_simple.json", 'w') as outfile:
            json.dump([{'id': ee['id'], 'place': ee['place'], 'data': ee['data']} for ee in popular_times], outfile, indent=2)
